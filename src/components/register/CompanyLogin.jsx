...
const CompanyLogin = ({ setCompanyRegister, setCompanyLogIn }) => {
  ...
  const submitLogin = async () => {
    openapi
      .generateTokenApiTokenPost("company", email, password)
      .then((response) => {
  ...
  return (
    <div className="login-form">
      <label className="title-login">
        Let's track your emloyees' productivity!
      </label>
      <div className="field">
        <label className="login-label">Company's Email address *</label>
        <div
